function manualEmailScript(e) { 
    return createManualCard(e); 
} 

function createManualCard(e) { 
    ...
    if (e && e.gmail && e.gmail.messageId) { 
       var messageId = e.gmail.messageId; 
        ...
        messageSection.addWidget(CardService.newTextInput()
            .setFieldName('emailType')
            .setTitle('Type of Email to Generate')
            .setHint('Enter the kind of email you want to generate (e.g., Thank You, Follow Up, Apology)'));
        messageSection.addWidget(CardService.newTextButton() 
            .setText('Generate Response') 
            .setOnClickAction(CardService.newAction() 
                .setFunctionName('generateResponse')
                .setParameters({ message: fullEmailBody, senderName: senderName, receiverName: receiverName, senderEmail: senderEmail, receiverEmail: receiverEmail, messageId: messageId })));
            
        messageSection.addWidget(CardService.newTextParagraph().setText('Email Content:')) 
    } else { 
